...
class autoCut():
    ...
    def addBgm(self):
        ...
        video_segment = draft.VideoSegment(material = video_material,
                                                        target_timerange  = trange(0, int(self.audioNowTime) + 500000),
                                                        volume=0)
...
#         "shiming": "蝶恋花·上巳召亲族",
#         "zuozhe": "李清照",
#         "yiwen": "醉中插花，花莫要笑我；只因人如春光将尽，令人怜惜。"
#     },
#     {
#         "id": "4",
#         "shangju": "花开为谁谢",
...
#         "shiming": "残花",
#         "zuozhe": "李清照",
#         "yiwen": "花开了又为谁凋谢？绽放了又为谁哀伤？"
#     }
# ]
# wenan = "其实我更喜欢，好多年前的自己"
# poetry_draft = autoCut(title="年少时的自己", wenan=wenan, list=list, bgm="我记得伴奏.mp3", bgv="金粉向右飘.mp4")
